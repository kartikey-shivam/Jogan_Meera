...
export default function Layout({ title, description, children }) {
  ...
  return (
    <div>
      <Head>
        <title>{title ? `${title} - Jogan Meera` : "Jogan Meera"}</title>
      ...
      <ThemeProvider theme={theme}>
          ...
          <Toolbar className={classes.toolbar}>
            <Box display="flex" alignItems="center">
              ...
              <NextLink href="/" passHref>
                <Link>
                  <Typography className={classes.brand}>Jogan Meera</Typography>
                </Link>
              </NextLink>
            </Box>
            <Drawer
        ...
        <footer className={classes.footer}>
          <Typography>All rights reserved. Jogan Meera.</Typography>
        </footer>
      </ThemeProvider>
    </div>
  );
